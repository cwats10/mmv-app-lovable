    ...
    <div className="border border-forest/20 bg-forest p-6">
      ...
      <div className="mt-4 flex items-center gap-2">
        <input
          readOnly
          value={url}
          className="flex-1 border border-forest-foreground/20 bg-forest-foreground/10 px-4 py-2.5 font-mono text-xs text-forest-foreground"
        />
        <button
          onClick={copy}
          className="flex items-center gap-1.5 border border-forest-foreground/30 px-4 py-2.5 font-inter text-sm text-forest-foreground transition-colors hover:bg-forest-foreground/10"
        >
